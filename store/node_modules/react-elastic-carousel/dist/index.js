...
var Carousel = /*#__PURE__*/function (_React$Component) {
  ...
  function Carousel() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onContainerResize", function (sliderContainerNode) {
      ...
      _this.setState({
        ...
        */
        ...
        var childWidth = verticalMode ? width : width / itemsToShow;
    ...
    _defineProperty(_assertThisInitialized(_this), "getNextItemIndex", function (currentIndex, getPrev) {
      ...
      var notEnoughItemsToShow = itemsToShow > children.length;
      var limit = getPrev ? 0 : children.length - itemsToShow;
    ...
    _defineProperty(_assertThisInitialized(_this), "onSwiping", function (data) {
      ...
      _this.setState(function (state) {
        ...
        var isOnEnd = activeIndex === children.length - itemsToShow;
        ...
        return {
          swipedSliderPosition: horizontalSwipe ? sliderPosition - deltaX : sliderPosition - deltaY,
          isSwiping: true,
          transitioning: true
        };
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "getNumOfPages", function () {
      ...
      var numOfPages = Math.ceil(children.length / itemsToShow);
      return numOfPages || 1;
    });
  ...
  _createClass(Carousel, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      var nextItem = this.getNextItemIndex(activeIndex, false); // update pages (for pagination)
